...
(function ($) {
    ...
    */
    ...
    var setDimensions = function () {
        ...
        newH = $(window).height() - $uploader.height() - $uploader.offset().top - bheight;
            ...
            if (data) {
                if ($('#fileinfo').data('view') === 'grid') {
                    ...
                    for (key in data) {
                        if (data.hasOwnProperty(key)) {
                            ...
                            result += '<li class="' + cap_classes
                                + '"' + title + '"><div class="clip"><img src="'
                                + data[key].Preview + '" width="' + scaledWidth
                                + '" alt="' + data[key].Path + '" data-path="'
                                + data[key].Path + '" /></div><p>'
                                + data[key].Filename + '</p>';
                    ...
                    result += '<thead><tr><th class="headerSortDown"><span>' + lg.name
                        + '</span></th><th><span>' + lg.dimensions + '</span></th><th><span>'
                        + lg.size + '</span></th><th><span>' + lg.modified + '</span></th></tr></thead>';
                    result += '<tbody>';
    ...
    function getFileInfo(file) {
        ...
        if ($.inArray('select', capabilities)  !== -1 && ($.urlParam('CKEditor') || window.opener || window.tinyMCEPopup || $.urlParam('field_name'))) {
                ...
                for (key in data) {
                    if (data.hasOwnProperty(key)) {
                        ...
                        if (data[key]['File Type'] === 'dir') {
                            extraclass = data[key].Protected === 0 ? '' : ' directory-locked';
                            ...
                            if (config.options.listFiles) {
                                extraclass = data[key].Protected === 0 ? '' : ' file-locked';
    ...
    $(function () {
        ...
        if (config.customScrollbar.enabled) {
            ...
            var csTheme = config.customScrollbar.theme !== undefined ? config.customScrollbar.theme : 'inset-2-dark',
                csButton = config.customScrollbar.button !== undefined ? config.customScrollbar.button : true;
